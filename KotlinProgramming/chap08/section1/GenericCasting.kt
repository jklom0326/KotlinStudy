...
fun main() {
    val obj1: Parent = Child() // Parent 형식의 obj1은 Child로 형변환 될 수 있음
//    val obj2: Child = Parent()       // 에러! 하위 형식인 Child의 객체 obj2는 Parent로 변환되지 않음
//    val obj3: Cup<Parent> = Cup<Child>() // 에러! 자료형 형식이 일치하지않음
//    val obj4: Cup<Child> = Cup<Parent>   // 에러! 자료형 형식이 일치하지않음
